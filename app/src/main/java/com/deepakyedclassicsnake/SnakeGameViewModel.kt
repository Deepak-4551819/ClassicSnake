...
// ViewModel is a part of Android architecture component that helps manage and purchase UI related data across configuration changes like screen rotation changing to light or dark mode hence we will use this viewModel for our state and events and for keeping those States we will use State flow
